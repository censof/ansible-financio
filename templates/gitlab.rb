...
## When bundled nginx is disabled we need to add the external webserver user to the GitLab webserver group.
 ...
 web_server['external_users'] = ['"{{ ansible_env.SUDO_USER}}"']
...
nginx['listen_port'] = 8080 # override only if you use a reverse proxy: https://gitlab.com/gitlab-org/omnibus-gitlab/blob/master/doc/settings/nginx.md#setting-the-nginx-listen-port
...
# nginx['custom_nginx_config'] = "include /etc/
#/conf.d/example.conf;"
